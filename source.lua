            -- // Cheat
            local CheatTable = {
                Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/ThatsMyMute/pf-lol-macsploit/main/ui.lua"))();
                Visuals = loadstring(game:HttpGet("https://raw.githubusercontent.com/ThatsMyMute/pf-lol-macsploit/main/esp.lua")).Body)();
                Connections = {};
                Measurements = {};
            };
